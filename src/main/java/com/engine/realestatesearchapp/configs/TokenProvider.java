package com.engine.realestatesearchapp.configs;
...
public class TokenProvider implements Serializable {
    ...
    private Integer accessTokenValiditySec;
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + accessTokenValiditySec * 1000))
                .compact();
    }
